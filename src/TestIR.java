	...
	public static void main(String[] args) {
		...
		if (salario >= 1900.0 && salario <= 2800.0 && checkFirstTax >= 145.00) {
			...
			if (salario >= 1900.0 && salario <= 2800.0 && checkFirstTax < 145.00) {
				...
				if (salario >= 2800.01 && salario <= 3571.0 && checkSecondeTax >= 350.00) {
					Double newSalario = salario - 350.00;
					System.out.println("o seu salario de " + salario + " tera um desconto de R$ 350.00 "
					...
					if (salario >= 2800.01 && salario <= 3571.0 && checkSecondeTax < 350.00) {
						...
						if (salario >= 3751.01 && checkThirdTax > 636.00) {
							Double newSalario = salario - 636.00;
							System.out.println(checkThirdTax);
							System.out.println("o seu salario de " + salario + " tera um desconto de R$ 636.00 "
									+ " o saldo sera: R$ " + newSalario);
